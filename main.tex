...
\textbf{位图索引}
\begin{itemize}
	\item 位图索引旨在对多个键同时进行高效查询。
	\item 引入：
	\begin{itemize}
		\item 记录按照顺序编号为$(R_0, R_1, R_2, \dots)$，给定$n$则检索$R_n$的效率很高。
		\item \textcolor{red}{仅对取值个数有限的属性特别适用。}
	\end{itemize}
	\item 
\end{itemize}
